...
import { Home, Search, Film, Heart, Download, Settings, } from "lucide-react"
      ...
      <aside className="sidebar">
        ...
        <nav className="nav-menu">
            <ul>
                ...
                <li><a href="#" data-tooltip="Movies"><Film /></a></li>
                <li><a href="#" data-tooltip="Favorites"><Heart /></a></li>
                <li><a href="#" data-tooltip="Downloads"><Download /></a></li>
